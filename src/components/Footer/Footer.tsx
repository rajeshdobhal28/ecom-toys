        ...
        <footer className={styles.footer}>
            <div className={`container ${styles.container}`}>
                <div className={styles.column}>
                    <h3 className={styles.logo}>Wonder<span className={styles.highlight}>Toys</span></h3>
                    <p className={styles.text}>
                        Bringing smiles to families with safe, educational, and fun toys since 2024.
                    </p>
                </div>
                ...
                <div className={styles.column}>
                    ...
                    <Link href="/safety" className={styles.link}>Toy Safety</Link>
                </div>

                <div className={styles.column}>
                    <h4 className={styles.heading}>Stay Connected</h4>
                    <p className={styles.text}>Join our newsletter for exclusive offers!</p>
            ...
            <div className={styles.bottom}>
                <div className="container" style={{ textAlign: 'center', fontSize: '0.9rem', color: '#B2BEC3' }}>
